...
class my_pass : public gimple_opt_pass
{
	public:
		...
		unsigned int execute (function *fun)
		{
			...
			/* FOR_ALL_BB_FN(bb,fun) macro leads to a 'seg fault'
			 * Instead, we use FOR_EACH_BB_FN(bb,fun) to avoid traversing
			 * artificial blocks added by the compiler to represent the function entry
			 * and function exit points */
